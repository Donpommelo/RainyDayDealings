...
public enum NameGenerator {
	...
	_NOTHING_("", "end", "gg", "dge", "m_", "n_", "r_", "le"),
	ART("art", "end", "gg", "m_", "n_", "r_"),
	SWORTH("sworth", "end", "a", "e", "i", "o", "u", "gg", "dge", "m_", "n_", "r_", "le"),
	BERG("berg", "end", "a", "e", "i", "o", "u", "m_", "n_", "r_", "le"),
	BERT("bert", "end", "a", "e", "i", "o", "u", "m_", "n_", "r_", "le"),
	BERRY("berry", "end", "gg", "dge", "m_", "n_", "r_"),
	BLATT("blatt", "end", "a", "e", "i", "o", "u", "m_", "n_", "r_", "le"),
	BOTTOMS("bottoms", "end", "a", "e", "i", "o", "u", "m_", "n_", "r_", "le"),
	DALE("dale", "end", "a", "e", "i", "o", "u", "gg", "m_", "n_", "r_", "le"),
	NUT("nut", "end", "gg", "dge", "m_", "n_", "r_"),
	SBY("sby", "end", "a", "e", "i", "o", "u", "gg", "m_", "n_", "r_", "le"),
	SMITH("smith", "end", "a", "e", "i", "o", "u", "m_", "n_", "r_", "le"),
	SON("son", "end", "m_", "n_", "r_"),
	TON("ton", "end", "m_", "n_", "r_"),
	INGTON("ington", "end", "m_", "n_", "r_"),

	O("o", "end", "gg", "r_"),
	Y("y", "end", "gg", "r_", "le"),
	R_END("r", "end", "le"),
	GINS("gins", "end", "r_", "le"),
	KINS("kins", "end", "gg", "r_", "le"),
